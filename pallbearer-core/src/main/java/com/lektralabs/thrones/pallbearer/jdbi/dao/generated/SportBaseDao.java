...
public interface SportBaseDao {
    ...
    @RegisterBeanMapper(SportRow.class)
    @UseStringTemplateSqlLocator
    @SqlQuery("select")
    Optional<SportRow> findById(UUID id);

    @RegisterBeanMapper(SportRow.class)
    @UseStringTemplateSqlLocator
    @SqlQuery("selectAll")
    List<SportRow> findAll(@Define("findOptions") String findOptions);

    @UseStringTemplateSqlLocator
    @SqlUpdate("insert")
    @GetGeneratedKeys("id")
    UUID insert(@BindBean SportRow item);

    @UseStringTemplateSqlLocator
    @SqlUpdate("update")
    int update(@BindBean SportRow item);
