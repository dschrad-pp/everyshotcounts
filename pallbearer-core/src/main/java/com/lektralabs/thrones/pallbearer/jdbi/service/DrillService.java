...
public class DrillService extends DrillBaseService {
    ...
    public int updateAttemptMediaId(UUID drillId, UUID mediaId, int version) {
        return drillAttemptHistoryService.updateMediaId(drillId, mediaId, version);
    }
    ...
    public int updateAttemptMediaIdByLocalId(String attemptLocalId, UUID mediaId) {
        return drillAttemptHistoryService.updateMediaIdByAttemptLocalId(attemptLocalId, mediaId);
    }
