...
public interface ContactBaseDao {
    ...
    @RegisterBeanMapper(ContactRow.class)
    @UseStringTemplateSqlLocator
    @SqlQuery("select")
    Optional<ContactRow> findById(UUID id);

    @RegisterBeanMapper(ContactRow.class)
    @UseStringTemplateSqlLocator
    @SqlQuery("selectAll")
    List<ContactRow> findAll(@Define("findOptions") String findOptions);

    @UseStringTemplateSqlLocator
    @SqlUpdate("insert")
    @GetGeneratedKeys("id")
    UUID insert(@BindBean ContactRow item);

    @UseStringTemplateSqlLocator
    @SqlUpdate("update")
    int update(@BindBean ContactRow item);
